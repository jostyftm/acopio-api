...
class RolePermissionSeeder extends Seeder
{
    ...
    private const MODULES = [
        ...
        'my-staff' => [
            ...
            'order' => 6,
            'parent' => null,
            'permissions' => ['my-staff.view', 'my-staff.list', 'my-staff.create', 'my-staff.update', 'my-staff.delete'],
        ],
        'affectations' => [
            'name' => 'Afectaciones reportadas',
            'path' => '/afectaciones',
            'icon' => 'Ambulance',
            'order' => 7,
            'parent' => null,
        ...
        'property-types' => [
            'name' => 'Tipos de predio',
            'path' => '/property-types',
            'icon' => 'House',
            'order' => 6,
            'parent' => 'system',
            'permissions' => ['property-types.view', 'property-types.list', 'property-types.create', 'property-types.update', 'property-types.delete'],
        ],
        'incident-types' => [
            'name' => 'Tipos de incidente',
            'path' => '/incident-types',
            'icon' => 'AlertTriangle',
            'order' => 7,
            'parent' => 'system',
